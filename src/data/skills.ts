...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Dio", level: 5 },
      { name: "JSON Serialization", level: 5 },
      { name: "Firebase Authentication", level: 4 },
      { name: "Firestore", level: 4 },
      { name: "FCM", level: 4 },
      { name: "Third-party SDK Integration", level: 4 },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Basic Unit Testing", level: 3 },
      { name: "Widget Testing (Learning Stage)", level: 2 },
    ],
  },
  {
    title: "Soft Skills",
