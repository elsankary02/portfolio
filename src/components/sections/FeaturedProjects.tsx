...
<<<<<<< HEAD
                          ...
                          >
=======
                          <div className={`absolute inset-0 bg-gradient-to-br ${project.gradient} blur-2xl scale-110 opacity-50`} />
                          <div className={`relative w-full h-full ${hasShowcase ? "" : "p-4"}`}>
>>>>>>> 1076294e81789e024649b94d1513ac2817be3a8e
...
=======
                                className={hasShowcase ? "object-cover" : "object-contain"}
                                sizes="(max-width: 1024px) 100vw, 60vw"
                                style={hasShowcase ? { transform: `scale(${imageScale})` } : undefined}
>>>>>>> 1076294e81789e024649b94d1513ac2817be3a8e
                              />
                            </div>
                          </div>
